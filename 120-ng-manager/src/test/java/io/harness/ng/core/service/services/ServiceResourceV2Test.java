...
public class ServiceResourceV2Test extends CategoryTest {
  ...
  public void testCreateService() throws IOException {
    when(serviceEntityManagementService.checkThatTheOrganizationAndProjectExists(
    ...
    verify(serviceEntityManagementService, times(1))
  ...
  @Owner(developers = SHIVAM)
  @Category(UnitTests.class)
  public void testListTemplate() throws IOException {
