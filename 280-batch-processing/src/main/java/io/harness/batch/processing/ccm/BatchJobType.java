...
public enum BatchJobType {
  ...
  INSTANCE_BILLING_HOURLY(600, 5, ChronoUnit.MINUTES, Arrays.asList(K8S_UTILIZATION), IN_CLUSTER_BILLING),
  ...
  INSTANCE_BILLING(750, 10, ChronoUnit.MINUTES, Arrays.asList(K8S_UTILIZATION), IN_CLUSTER_BILLING),
