...
public class StateMachineEventPublisherServiceImpl implements StateMachineEventPublisherService {
  ...
  @Override
  public void registerTaskComplete(String accountId, String taskId, String verifictionTaskId) {
    StateMachineTrigger trigger =
        StateMachineTrigger.newBuilder().setLearningTaskId(taskId).setVerificationTaskId(verifictionTaskId).build();
