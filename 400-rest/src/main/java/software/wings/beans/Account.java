...
public class Account extends Base implements PersistentRegularIterable {
  ...
  @FdIndex private Long perpetualTaskAccountLevelIteration;
  ...
  public void updateNextIteration(String fieldName, long nextIteration) {
    ...
    else if (AccountKeys.perpetualTaskAccountLevelIteration.equals(fieldName)) {
      this.perpetualTaskAccountLevelIteration = nextIteration;
      return;
    }
  ...
  public Long obtainNextIteration(String fieldName) {
    if (AccountKeys.serviceGuardDataCollectionIteration.equals(fieldName)) {
      ...
      return this.perpetualTaskAccountLevelIteration;
    }
  ...
  public static final class AccountKeys {
    ...
    public static final String perpetualTaskAccountLevelIteration = "perpetualTaskAccountLevelIteration";
