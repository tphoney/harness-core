...
import io.harness.perpetualtask.AzureInfraPTClientParams;
...
@Slf4j
@OwnedBy(CDP)
public class AzureInfraInstanceSyncPerpetualTaskCreator extends AbstractInstanceSyncPerpetualTaskCreator {
  @Override
  ...
  private List<String> create(AzureInfraPTClientParams clientParams, InfrastructureMapping infraMapping) {
    ...
    PerpetualTaskSchedule schedule = PerpetualTaskSchedule.newBuilder()
                                         ...
                                         .build();
    return singletonList(perpetualTaskService.createTask(PerpetualTaskType.AZURE_INFRA_INSTANCE_SYNC,
  ...
  private List<String> createPerpetualTaskInternal(InfrastructureMapping infrastructureMapping) {
    AzureInfraPTClientParams params = AzureInfraPTClientParams.builder()
