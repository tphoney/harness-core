...
@Data
@Builder
@Document(MongoReconciliationOffset.PRIMARY_COLLECTION)
@Entity(value = MongoReconciliationOffset.PRIMARY_COLLECTION, noClassnameStored = true)
@FieldNameConstants(innerTypeName = "keys")
@StoreIn(PMS)
@TypeAlias(MongoReconciliationOffset.PRIMARY_COLLECTION)
