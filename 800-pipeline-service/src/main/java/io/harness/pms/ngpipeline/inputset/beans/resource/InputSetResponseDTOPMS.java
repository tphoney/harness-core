...
public class InputSetResponseDTOPMS {
  ...
  @Schema(description = PipelineResourceConstants.INPUT_SET_YAML_MESSAGE) String inputSetYaml;
  ...
  @Schema(description = PipelineResourceConstants.INPUT_SET_ERROR_MESSAGE)
