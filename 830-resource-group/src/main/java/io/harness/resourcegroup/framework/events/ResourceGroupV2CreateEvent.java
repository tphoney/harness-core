...
@Getter
@NoArgsConstructor
public class ResourceGroupV2CreateEvent implements Event {
  String accountIdentifier;
  ResourceGroupV2DTO resourceGroup;

  public ResourceGroupV2CreateEvent(String accountIdentifier, ResourceGroupV2DTO resourceGroup) {
