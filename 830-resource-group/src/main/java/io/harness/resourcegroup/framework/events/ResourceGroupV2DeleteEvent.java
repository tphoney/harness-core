...
@Getter
@NoArgsConstructor
public class ResourceGroupV2DeleteEvent implements Event {
  String accountIdentifier;
  ResourceGroupV2DTO resourceGroup;

  public ResourceGroupV2DeleteEvent(String accountIdentifier, ResourceGroupV2DTO resourceGroup) {
