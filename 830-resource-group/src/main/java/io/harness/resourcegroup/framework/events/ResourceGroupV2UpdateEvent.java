...
@Getter
@NoArgsConstructor
public class ResourceGroupV2UpdateEvent implements Event {
  String accountIdentifier;
  ResourceGroupV2DTO newResourceGroup;
  ResourceGroupV2DTO oldResourceGroup;

  public ResourceGroupV2UpdateEvent(
      String accountIdentifier, ResourceGroupV2DTO newResourceGroup, ResourceGroupV2DTO oldResourceGroup) {
