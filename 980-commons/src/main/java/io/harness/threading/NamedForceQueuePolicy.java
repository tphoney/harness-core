 ...
 */
@Slf4j
public class NamedForceQueuePolicy implements RejectedExecutionHandler {
  private final String name;

  public NamedForceQueuePolicy(String name) {
    this.name = name;
  }
  ...
  public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
    try {
      log.info(
          "[Identifier]: {} rejectedExecution occurred - will force the thread pool to increase pool size. Current queue size is {}",
